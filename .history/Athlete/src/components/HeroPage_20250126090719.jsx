  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        {governmentSchemes.map((scheme, index) => (
          <div 
            ...
            className={`absolute inset-0 transition-opacity duration-500 
              ${currentSchemeSlide === index ? 'opacity-100' : 'opacity-0'}`}
          >
            <div 
            ...
            <div className="relative z-10 flex items-center justify-center h-full text-white px-8">
              <div className="max-w-xl text-center">
                <h2 className="text-4xl font-bold mb-4">{scheme.title}</h2>
                <p className="text-xl mb-6">{scheme.description}</p>
          ...
          {governmentSchemes.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full 
                ${currentSchemeSlide === index ? 'bg-white' : 'bg-white/50'}`}
            />
          ))}
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12 bg-gray-50">
        <h2 className="text-3xl font-bold mb-6">Athlete Community Posts</h2>
        <div className="grid md:grid-cols-2 gap-6">
