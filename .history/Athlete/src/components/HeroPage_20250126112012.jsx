    ...
    <div className="min-h-screen bg-gray-50 pl-20 dark:bg-gray-900">
          ...
          <div className="absolute inset-0  bg-opacity-50">
            <div className="container mx-auto px-6 h-full flex items-center">
              <div className="text-white max-w-3xl">
                ...
                <button className="bg-orange-700 hover:bg-orange-800 text-white px-8 py-3 rounded-lg font-semibold">
                  Learn More
                </button>
              </div>
            </div>
      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="mb-6 md:mb-0">
          <h1 className="text-2xl font-bold">Sports India</h1>
        </div>
        ...
        <div className="mb-6 md:mb-0">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#schemes" className="hover:text-blue-400">Schemes</a></li>
            <li><a href="#matches" className="hover:text-blue-400">Upcoming Matches</a></li>
      ...
      <div className="bg-gray-900 text-center py-4">
        <p className="text-sm">© 2025 Sports India. All Rights Reserved.</p>
      </div>
    </footer>
    </div>
  );
