...
// Import local images
import kheloIndiaImage from 'https://v3img.voot.com/v3Storage/assets/khelo_india_horizontal%20(1)-1685024326819.jpg';
import topsSchemesImage from 'https://v3img.voot.com/v3Storage/assets/khelo_india_horizontal%20(1)-1685024326819.jpg';
import sportsDevelopmentImage from 'https://v3img.voot.com/v3Storage/assets/khelo_india_horizontal%20(1)-1685024326819.jpg';

const schemes = [
  {
    title: "Khelo India Youth Games",
    description: "Supporting young athletes with annual scholarships of ₹5 lakhs",
    image: kheloIndiaImage
  },
  {
    title: "Target Olympic Podium Scheme (TOPS)",
    description: "Elite athlete support program for Olympic preparation",
    image: topsSchemesImage
  },
  {
    title: "National Sports Development Fund",
    description: "Financial assistance for sports infrastructure and training",
    image: sportsDevelopmentImage
  }
];
