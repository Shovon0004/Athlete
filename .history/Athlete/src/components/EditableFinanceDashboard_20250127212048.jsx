...
const EditableFinanceDashboard = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto import React, { useState } from "react";
import { motion } from "framer-motion";
import {
  LineChart,
  Line,
...
const EditableFinanceDashboard = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 space-y-6 bg-gray-900 text-gray-100 rounded-lg shadow-md">
      {/* Edit Mode Toggle */}
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-lg font-bold mb-4">Athlete Goals</h2>
        <div className="space-y-4">
          {goals.map((goal) => (
            <motion.div
              key={goal.id}
            ...
            >
              <div className="flex-grow">
                ...
                <p className="text-sm text-gray-400">{goal.status}</p>
              </div>
              {isEditing && (
                <motion.button
...
export default EditableFinanceDashboard;
 bg-gray-900 text-gray-100 rounded-lg shadow-md">
      {/* Edit Mode Toggle */}
      <div className="flex justify-end">
        <motion.button
          whileHover={{ scale: 1.05 }}
