...
const EditableFinanceDashboard = () => {
  ...
  expenseCategories={expenseCategories}
      />
      <image src="https://www.freepik.com/free-psd/3d-white-figure-weightlifting-barbell-with-blue-weights-squat-exercise-gym-fitness-concept_411055092.htm#fromView=keyword&page=1&position=12&uuid=5b544a87-2673-49bc-a022-da4e288a7050&new_detail=true&query=Athlete+3d" alt="Athlete" className="w-full h-96 object-cover rounded-lg" />  
    </div>
  );
};
