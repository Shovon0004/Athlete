...
const EditableFinanceDashboard = () => {
  ...
  expenseCategories={expenseCategories}
      />
      <motion.div
        className="p-4 bg-gray-800 rounded-lg shadow mt-4"
        whileHover={{ scale: 1.02 }}
      >
        <h2 className="text-lg font-bold mb-4">Motivational Image</h2>
        <img
          src="https://img.freepik.com/free-psd/3d-white-figure-weightlifting-barbell-with-blue-weights-squat-exercise-gym-fitness-concept_632498-32252.jpg?t=st=1737994232~exp=1737997832~hmac=370c5cd06a12e36d6807ef265c58abfe9eeab6c23e52edb246e0b702b449fe90&w=826"
          alt="Motivational Placeholder"
