...
const EditableFinanceDashboard = () => {
  ...
  expenseCategories={expenseCategories}
      />
      <image src="https://img.freepik.com/premium-photo/3d-character-portraits-young-athlete_567739-8647.jpg" alt="Athlete" className="w-full h-96 object-cover rounded-lg" />  
    </div>
  );
};
